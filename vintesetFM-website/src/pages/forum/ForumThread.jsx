...
import { ChevronLeft, Pin, Lock, Trash2, ShieldAlert, MessageSquare } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto" data-color-mode="dark">
      ...
      <div className="bg-white/5 border border-white/10 rounded-xl overflow-hidden mb-6 flex flex-col md:flex-row">
        ...
        {/* Content */}
        <div className="p-6 flex-1 bg-[#0d1117] break-words overflow-x-auto"> 
          {/* MDEditor Preview - Force Github Dark Theme aesthetics over the body */}
